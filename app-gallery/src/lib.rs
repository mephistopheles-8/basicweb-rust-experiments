      ...
      .service( 
          web::scope("/api/v1/")
            .service(web::resource("/public/tags")
               .route(web::get().to(routes::user_tag::user_tags_public_json))
            )
            ...
            .service(web::resource("/tags")
                .route(web::get().to(routes::user_tag::user_tags_all_by_login_json))
            )
          ...
          .service(web::resource("/u/{handle}/tags")
              .route(web::get().to(routes::user_tag::user_tags_public_by_handle_json))
          )
